...
interface Message {
    ...
    timestamp: Date;
    image?: string;
    steps?: string[]; // 🔹 Hata / çözüm adımları için
}
...
export default function ChatPage() {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            // 🔹 Backend GenerationResponse { title, steps } bekliyoruz
            const aiMessage: Message = {
                id: `${Date.now()}-ai`,
                role: "assistant",
                content: data.title || "AI Analiz Sonucu",
                steps: data.steps || [],
                timestamp: new Date(),
            };
            ...
            const errorMessage: Message = {
                ...
                role: "assistant",
                content:
                    "❌ Sunucuya bağlanılamadı veya geçersiz yanıt alındı. Lütfen backend'i kontrol edin.",
                timestamp: new Date(),
            };
                                ...
                                <div className="flex gap-4">
                                    <div className="flex-shrink-0 mt-1">
                                        {message.role === "assistant" ? (
                                            <div className="w-7 h-7 rounded-md bg-gradient-to-br from-amber-600 to-orange-600 dark:from-indigo-600 dark:to-blue-600 flex items-center justify-center text-white text-xs shadow-sm">
                                                AI
                                            </div>
                                        ) : (
                                            <div className="w-7 h-7 rounded-md bg-blue-600 flex items-center justify-center text-white text-xs shadow-sm">
                                                U
                                            </div>
                                        )}
                                    </div>
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-white">
                                                ...
                                                <div>
                                                    ...
                                                    {message.steps.map((step, i) => {
                                                        ...
                                                        return (
                                                            <div
                                                                key={i}
                                                                className="mb-3 p-3 rounded-lg border bg-gray-50 dark:bg-slate-800 dark:border-slate-700"
                                                            >
                                                                <p>
                                                                    <strong>{hata}</strong>
                                                                </p>
                        ...
                        {isLoading && (
                            <div className="flex gap-4 animate-pulse">
                                <div className="w-7 h-7 rounded-md bg-gray-300 dark:bg-slate-700" />
            ...
            <div className="border-t border-gray-200 dark:border-slate-700 bg-white dark:bg-[#1e293b] transition-colors">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4">
                    {uploadedImage && (
                        <div className="mb-3 relative inline-block">
                            <img
                                src={uploadedImage}
                                alt="Preview"
                                className="max-h-32 rounded-lg border-2 border-gray-200 dark:border-slate-600 shadow-sm"
                            />
                            <button
                    ...
                    <div className="relative flex items-end gap-2">
                        ...
                        <button
                            ...
                            className="flex-shrink-0 p-2.5 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-700 rounded-lg transition-colors"
                        >
                            📷
                        </button>
              ...
              />
                        ...
                        <button
                            ...
                            className="flex-shrink-0 p-2.5 bg-gray-900 dark:bg-indigo-600 text-white rounded-lg hover:bg-gray-700 dark:hover:bg-indigo-500 transition-colors disabled:opacity-40"
                        >
                            ➤
                        </button>
                    </div>
