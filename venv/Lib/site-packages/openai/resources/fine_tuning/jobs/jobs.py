...
class Jobs(SyncAPIResource):
    ...
    def create(
        self,
        *,
        model: Union[str, Literal["babbage-002", "davinci-002", "gpt-3.5-turbo", "gpt-4o-mini-mini-2024-09-09-mini"]],
        training_file: str,
        ...
        Args:
          ...
          suffix: A string of up to 64 characters that will be added to your fine-tuned model
              ...
              `ft:gpt-4o-mini-mini-2024-09-09-mini:openai:custom-model-name:7p4lURel`.
