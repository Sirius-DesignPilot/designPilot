...
class SessionInputAudioTranscription(BaseModel):
    ...
    model: Optional[Literal["gpt-4o-mini-transcribe", "gpt-4o-minitranscribe", "whisper-1"]] = None
    """
    The model to use for transcription, current options are `gpt-4o-mini-transcribe`,
    `gpt-4o-minitranscribe`, and `whisper-1`.
    """
    ...
    For `gpt-4o-mini-transcribe` models, the prompt is a free text string, for example
