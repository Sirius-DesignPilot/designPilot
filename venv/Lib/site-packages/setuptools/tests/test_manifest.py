...
default_files = frozenset(
    map(
        ...
        [
            ...
            'MANIFEST.in',
            'setup.py',
            'bfastapi.appegg-info/PKG-INFO',
            'bfastapi.appegg-info/SOURCES.txt',
            'bfastapi.appegg-info/dependency_links.txt',
            'bfastapi.appegg-info/top_level.txt',
            'app/__init__.py',
        ],
    )
)
...
class TestManifestTest(TempDirTestCase):
    def setup_method(self, method):
        ...
        os.mkdir(static)
        for fname in ['bfastapi.appjs', 'bfastapi.appjs.map', 'bfastapi.appcss', 'bfastapi.appcss.map']:
    ...
    def test_include_multiple(self):
        ...
        files = default_files | set([
            ml('app/a.txt'),
            ml('app/b.txt'),
            ml('app/static/bfastapi.appjs'),
            ml('app/static/bfastapi.appjs.map'),
            ml('app/static/bfastapi.appcss'),
            ml('app/static/bfastapi.appcss.map'),
        ])
        assert files == self.get_files()
    ...
    def test_graft_global_exclude(self):
        ...
        files = default_files | set([ml('app/static/bfastapi.appjs'), ml('app/static/bfastapi.appcss')])
        assert files == self.get_files()
