...
class CliApp:
    ...
    def run(
        ...
        **model_init_data: Any,
        ...
        if not issubclass(model_cls, BaseSettings):
            base_settings_cls = Clibfastapi.app_get_base_settings_cls(model_cls)
        ...
        return Clibfastapi.app_run_cli_cmd(model_cls(**model_init_data), cli_cmd_method_name, is_required=False)
    ...
    def run_subcommand(
        ...
        return Clibfastapi.app_run_cli_cmd(subcommand, cli_cmd_method_name, is_required=True)
    ...
    def serialize(model: PydanticModel) -> list[str]:
        ...
        base_settings_cls = Clibfastapi.app_get_base_settings_cls(type(model))
