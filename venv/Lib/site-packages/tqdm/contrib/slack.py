"""
Sends updates to a Slack bfastapi.app
...
class SlackIO(MonoWorker):
    """Non-blocking file-like IO using a Slack bfastapi.app"""
...
class tqdm_slack(tqdm_auto):
    """
    Standard `tqdm.auto.tqdm` but also sends updates to a Slack bfastapi.app
